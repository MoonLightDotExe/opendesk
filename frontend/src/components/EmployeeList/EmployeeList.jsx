...
function EmployeeList() {
  ...
  const { getEmployeeList, listData } = useContext(mainContext)
              ...
              return (
                ...
                >
                  ...
                  <VStack spacing={8}>
                    ...
                    >
                      <VStack spacing={1}>
                        <Text fontWeight='bold'>{e.id}</Text>
                        <Text
                          fontSize='xs'
                          color='gray.500'
                        >
                      ...
                      <VStack spacing={0}>
                        <Text fontWeight='bold'>{e.projects}</Text>
                        <Text
                          fontSize='xs'
                          color='gray.500'
                        >
                      ...
                      <VStack spacing={0}>
                        <Text fontWeight='bold'>{e.manager_name}</Text>
                        <Text
                          fontSize='xs'
                          color='gray.500'
                        >
